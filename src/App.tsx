...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#FAF9F6] text-slate-800 antialiased selection:bg-cyan-100 selection:text-cyan-900">
      ...
      {/* HEADER */}
      <header className={`fixed top-0 sm:top-18 left-0 right-0 z-40 transition-all duration-300 ${scrolled ? 'bg-white shadow-lg py-2 border-b border-cyan-50' : 'bg-transparent py-4'}`}>
